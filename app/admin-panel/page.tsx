...
export default function AdminPanelRoot() {
  // Middleware login kontrolünü yapıyor. Şimdilik tek sayfa dashboard.
  return (
      ...
      <div className="admin-layout">
        <aside className="admin-sidebar">
          ...
          <nav className="admin-nav">
            ...
            <a className="admin-nav__item active" href="/admin-panel">
              Popup Yönetimi
            </a>
          </nav>
        </aside>
        ...
        <section className="admin-main">
          <header className="admin-topbar">
            <div className="admin-topbar__title">Popup Yönetimi</div>
