            ...
            <div className="pd-hero-grid">
              ...
              <div className="pd-hero-content" data-pd-animate="fade-left">
                ...
                <div className="pd-hero-actions">
                  <Link href="/iletisim" className="pd-btn pd-btn--primary">
            ...
            <div className="pd-inner">
              ...
              <div className="pd-posters-list">
                {posters.map((poster, i) => (
                  ...
                  >
                    <div className="pd-poster-label">
                      <span className="pd-poster-index">{String(i + 1).padStart(2, "0")}</span>
                      <span className="pd-poster-name">{poster.title}</span>
                    </div>
